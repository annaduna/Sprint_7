...
class TestCourierLogin:
    ...
    def test_courier_login_success(self,courier_cleanup):
    ...
    def test_courier_login_missing_login(self,courier_cleanup):
        courier_data = generate_courier()
        create_response = CourierMethod.create_courier(courier_data)
        assert create_response.status_code == 201, "Курьер не создан"
    ...
    def test_courier_login_missing_password(self,courier_cleanup):
        courier_data = generate_courier()
        create_response = CourierMethod.create_courier(courier_data)
        assert create_response.status_code == 201, "Курьер не создан"
    ...
    def test_courier_login_invalid_credentials(self,courier_cleanup):
        login_data = {
            "login": "ghmghmg",
            "password": "5474635"
        }
